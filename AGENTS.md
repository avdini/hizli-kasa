...
1. **Check Documentation First:** Always read the guidelines before making any changes. The files are located at:
   - **Modern ACS Path:** `.agents/context/guidelines.md`, `.agents/skills/api-development/SKILL.md`, and `.agents/skills/release-workflow/SKILL.md`
...
7. **Automated Release Workflow ("güncelle" Command):** When the user says **"güncelle"**, **"sürüm yayınla"**, or **"versiyon yükselt"**, immediately execute the skill in `.agents/skills/release-workflow/SKILL.md`.