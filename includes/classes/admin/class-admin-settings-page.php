    ...
    public static function render() {
        ...
        <div class="wrap">
            ...
            <h2 class="nav-tab-wrapper">
                <a href="?page=hizli-kasa&tab=stok" class="nav-tab <?php echo $active_tab == 'stok' ? 'nav-tab-active' : ''; ?>">Stok YÃ¶netimi</a>
                <a href="?page=hizli-kasa&tab=depolar" class="nav-tab <?php echo $active_tab == 'depolar' ? 'nav-tab-active' : ''; ?>">Depo YÃ¶netimi</a>
                <a href="?page=hizli-kasa&tab=unmatched" class="nav-tab <?php echo $active_tab == 'unmatched' ? 'nav-tab-active' : ''; ?>">EÅŸleÅŸmeyen ÃœrÃ¼nler<?php echo $badge; ?></a>
                ...
                <a href="?page=hizli-kasa&tab=onbellek" class="nav-tab <?php echo $active_tab == 'onbellek' ? 'nav-tab-active' : ''; ?>">Ã–nbellek (Cache)</a>
                <a href="?page=hizli-kasa&tab=araclar" class="nav-tab <?php echo $active_tab == 'araclar' ? 'nav-tab-active' : ''; ?>">Sistem AraÃ§larÄ±</a>
            </h2>
