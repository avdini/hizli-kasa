...
add_action('wp_ajax_hizli_kasa_sync_wh_to_wc_start', 'hizli_kasa_ajax_sync_wh_to_wc_start');
add_action('wp_ajax_hizli_kasa_sync_wh_to_wc_step', 'hizli_kasa_ajax_sync_wh_to_wc_step');
 ...
 */
function hizli_kasa_ajax_sync_wh_to_wc_start() {
 ...
 */
function hizli_kasa_ajax_sync_wh_to_wc_step() {
    if (!current_user_can('manage_options')) {
        wp_send_json_error(['message' => 'Yetkisiz erişim!']);
    }
