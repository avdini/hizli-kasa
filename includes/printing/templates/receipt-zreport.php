...
?>
<div class="hk-unified-print-container receipt-zreport" style="font-family:'Courier New', Courier, monospace; color:#000; background:#fff; width:100%; max-width:300px; margin:0 auto; padding:4px 0; box-sizing:border-box; font-size:12px; line-height:1.2; box-shadow:none !important; border:none !important;">
    ...
    <?php elseif ((int) ($rapor['siparis_sayisi'] ?? 0) === 0 && (float) $value($ozet, 'toplam_iade') <= 0 && (float) $value($ozet, 'toplam_masraf') <= 0): ?>
        <p style="text-align:center; font-size:13px; margin:15px 0; color:#000; font-family:'Courier New', Courier, monospace;">Bugün işlem yapılmamıştır.</p>
    <?php else:
        ...
        ?>
        <div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px; border-bottom:1px solid #000; padding-bottom:2px; color:#000; font-family:'Courier New', Courier, monospace;">GENEL ÖZET</p><table style="width:100%; font-size:12px; border-collapse:collapse; color:#000; font-family:'Courier New', Courier, monospace;">
        ...
        <div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px; border-bottom:1px solid #000; padding-bottom:2px; color:#000; font-family:'Courier New', Courier, monospace;">ÖDEME DAĞILIMI</p><table style="width:100%; font-size:12px; border-collapse:collapse; color:#000; font-family:'Courier New', Courier, monospace;">
