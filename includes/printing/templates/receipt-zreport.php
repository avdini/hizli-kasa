...
<div class="hk-unified-print-container receipt-zreport" style="font-family:'Courier New', Courier, monospace; color:#000; width:80mm; max-width:80mm; margin:0; padding:3mm; background:#fff; box-sizing:border-box; font-size:12px; line-height:1.3;">
    ...
    <?php if (!$include_details):
        ...
        <div style="margin-bottom:10px;">
            <table style="width:100%; font-size:14px; border-collapse:collapse; font-family:monospace;">
                <tr><td style="padding:4px 0;">GENEL TOPLAM</td><td style="text-align:right; font-weight:bold;"><?php echo esc_html($money($general_total)); ?></td></tr>
    ...
    <?php else:
        ...
        ?>
        <div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px;">GENEL ÖZET</p><table style="width:100%; font-size:12px; border-collapse:collapse;">
        ...
        <div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px;">ÖDEME DAĞILIMI</p><table style="width:100%; font-size:12px; border-collapse:collapse;">
            ...
            <tr><td style="font-weight:bold; font-size:14px; padding-top:2px;">TOPLAM CİRO</td><td style="text-align:right; font-weight:bold; font-size:14px; padding-top:2px;"><?php echo esc_html($money($base_total)); ?></td></tr>
        </table></div>
        <?php
        $total_expense = $base_refund + ($is_general ? (float) $value($ozet, 'toplam_masraf') : 0);
        if ($total_expense > 0): ?>
            <div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px;">GİDERLER</p><table style="width:100%; font-size:12px; border-collapse:collapse;">
                ...
                <tr><td style="font-weight:bold; font-size:13px; padding-top:2px;">TOPLAM GİDER</td><td style="text-align:right; font-weight:bold; font-size:13px; padding-top:2px;">-<?php echo esc_html($money($total_expense)); ?></td></tr>
            </table></div>
        <?php endif; ?>
