...
?>
<div class="hk-unified-print-container receipt-zreport" style="font-family: Arial, Helvetica, sans-serif; color:#000; background:#fff; width:100%; max-width:300px; margin:0 auto; padding:4px 0; box-sizing:border-box; font-size:12px; line-height:1.2; box-shadow:none !important; border:none !important;">
    <div style="text-align:center; margin-bottom:8px; border-bottom:1px solid #000; padding-bottom:8px;">
        ...
        <p style="margin:4px 0 2px 0; font-size:13px; font-weight:bold; color:#000;"><?php echo $is_general ? 'GENEL GÜN SONU RAPORU' : 'GÜN SONU RAPORU'; ?></p>
        <p style="margin:0; font-size:11px; color:#000;">Kasa: <?php echo esc_html($kasa_no . ($depo_name ? ' / ' . $depo_name : '')); ?></p>
        <p style="margin:2px 0 0 0; font-size:11px; color:#000;"><?php echo esc_html($date_label); ?></p>
        <p style="margin:2px 0 0 0; font-size:10px; color:#000;">Rapor Zamanı: <?php echo esc_html($report_time); ?></p>
    </div>
    ...
    <?php elseif ((int) ($rapor['siparis_sayisi'] ?? 0) === 0 && (float) $value($ozet, 'toplam_iade') <= 0 && (float) $value($ozet, 'toplam_masraf') <= 0): ?>
        <p style="text-align:center; font-size:13px; margin:15px 0; color:#000;">Bugün işlem yapılmamıştır.</p>
    <?php else:
        ...
        ?>
        <div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px; border-bottom:1px solid #000; padding-bottom:2px; color:#000;">GENEL ÖZET</p><table style="width:100%; font-size:12px; border-collapse:collapse; color:#000;">
        ...
        <div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px; border-bottom:1px solid #000; padding-bottom:2px; color:#000;">ÖDEME DAĞILIMI</p><table style="width:100%; font-size:12px; border-collapse:collapse; color:#000;">
        ...
        if ($total_expense > 0): ?>
            <div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px; border-bottom:1px solid #000; padding-bottom:2px; color:#000;">GİDERLER</p><table style="width:100%; font-size:12px; border-collapse:collapse; color:#000;">
        ...
        <?php endif; ?>
        <div style="margin-bottom:8px;"><p style="font-weight:bold; font-size:12px; text-align:center; margin:0 0 4px; border-bottom:1px solid #000; padding-bottom:2px; color:#000;">--- NET KASA DURUMU ---</p><table style="width:100%; font-size:12px; border-collapse:collapse; color:#000;">
            ...
            <tr style="border-top:1px solid #000;"><td style="font-weight:bold; font-size:13px; padding-top:3px;">NET KASA TOPLAMI</td><td style="text-align:right; font-weight:bold; font-size:13px; padding-top:3px;"><?php echo esc_html($money($net_total - ($is_general ? (float) $value($ozet, 'toplam_masraf') : 0))); ?></td></tr>
        </table></div>
        <?php if (!empty($rapor['urun_dagilimi'])): ?><div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px; border-bottom:1px solid #000; padding-bottom:2px; color:#000;">ÜRÜN DAĞILIMI</p><table style="width:100%; font-size:11px; border-collapse:collapse; color:#000;"><tr><th style="text-align:left;">Ürün</th><th style="text-align:right;">Ad.</th><th style="text-align:right;">Tutar</th></tr><?php foreach ($rapor['urun_dagilimi'] as $item): ?><tr><td style="padding:1px 0; max-width:140px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;"><?php echo esc_html($item['name'] ?? ''); ?></td><td style="text-align:right; padding:1px 0;"><?php echo esc_html($item['qty'] ?? 0); ?></td><td style="text-align:right; padding:1px 0;"><?php echo esc_html($money($item['total'] ?? 0)); ?></td></tr><?php endforeach; ?></table></div><?php endif; ?>
        <?php if (!empty($rapor['siparisler'])): ?><div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px; border-bottom:1px solid #000; padding-bottom:2px; color:#000;">SİPARİŞLER (<?php echo esc_html($rapor['siparis_sayisi'] ?? 0); ?>)</p><table style="width:100%; font-size:11px; border-collapse:collapse; color:#000;"><tr><th style="text-align:left;">Saat</th><th style="text-align:left;">No</th><th style="text-align:left;">Ödm.</th><th style="text-align:right;">Tutar</th></tr><?php foreach ($rapor['siparisler'] as $item): ?><tr><td style="padding:1px 0;"><?php echo esc_html($item['saat'] ?? ''); ?></td><td style="padding:1px 0;">#<?php echo esc_html($item['id'] ?? ''); ?></td><td style="padding:1px 0; max-width:50px; overflow:hidden;"><?php echo esc_html(substr($item['odeme_tipi'] ?? '', 0, 6)); ?></td><td style="text-align:right; padding:1px 0;"><?php echo esc_html($money($item['toplam'] ?? 0)); ?></td></tr><?php endforeach; ?></table></div><?php endif; ?>
        <?php if (!empty($rapor['iade_siparisler'])): ?><div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px; border-bottom:1px solid #000; padding-bottom:2px; color:#000;">İADE İŞLEMLERİ (<?php echo esc_html($value($ozet, 'iade_adet')); ?>)</p><table style="width:100%; font-size:11px; border-collapse:collapse; color:#000;"><tr><th style="text-align:left;">Saat</th><th style="text-align:left;">No</th><th style="text-align:left;">Ödm.</th><th style="text-align:right;">Tutar</th></tr><?php foreach ($rapor['iade_siparisler'] as $item): ?><tr><td style="padding:1px 0;"><?php echo esc_html($item['saat'] ?? ''); ?></td><td style="padding:1px 0;">#<?php echo esc_html($item['id'] ?? ''); ?></td><td style="padding:1px 0; max-width:50px; overflow:hidden;"><?php echo esc_html(substr($item['odeme_tipi'] ?? '', 0, 6)); ?></td><td style="text-align:right; padding:1px 0;">-<?php echo esc_html($money($item['toplam'] ?? 0)); ?></td></tr><?php endforeach; ?></table></div><?php endif; ?>
        <?php if ($is_general && !empty($rapor['masraf_detay'])): ?><div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px; border-bottom:1px solid #000; padding-bottom:2px; color:#000;">MASRAFLAR (<?php echo count($rapor['masraf_detay']); ?>)</p><table style="width:100%; font-size:11px; border-collapse:collapse; color:#000;"><tr><th style="text-align:left;">Kategori</th><th style="text-align:right;">Tutar</th></tr><?php foreach ($rapor['masraf_detay'] as $item): ?><tr><td style="padding:1px 0; max-width:140px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;"><?php echo esc_html($item['kategori'] ?? ''); ?></td><td style="text-align:right; padding:1px 0;">-<?php echo esc_html($money($item['tutar'] ?? 0)); ?></td></tr><?php endforeach; ?></table></div><?php endif; ?>
        <?php if (!empty($rapor['kasiyerler'])): ?><div style="margin-bottom:8px;"><p style="font-weight:bold; margin:0 0 4px; font-size:12px; border-bottom:1px solid #000; padding-bottom:2px; color:#000;">KASİYERLER</p><table style="width:100%; font-size:11px; border-collapse:collapse; color:#000;"><?php foreach ($rapor['kasiyerler'] as $cashier => $count): ?><tr><td><?php echo esc_html($cashier); ?></td><td style="text-align:right;"><?php echo esc_html($count); ?> sipariş</td></tr><?php endforeach; ?></table></div><?php endif; ?>
        <div style="text-align:center; margin-top:10px; border-top:1px solid #000; padding-top:8px; font-size:10px; color:#000;"><p style="margin:0;">Bu rapor Hızlı Kasa POS sistemi tarafından üretilmiştir.</p></div>
    <?php endif; ?>
</div>
