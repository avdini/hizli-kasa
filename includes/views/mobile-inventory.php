            ...
            <div id="scanner-wrapper" class="collapsed">
                ...
                <div id="scanner-camera-controls" class="scanner-camera-controls">
                    <div class="controls-row">
                        ...
                        <button type="button" id="quality-toggle-btn" class="camera-tool-btn" title="Kalite Değiştir">
                    ...
                    <div class="controls-row">
                        <button type="button" id="zoom-out-btn" class="camera-tool-btn" title="Uzaklaştır">
                            <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="11" x2="14" y2="11"/></svg>
                        </button>
                        ...
                        <button type="button" id="zoom-in-btn" class="camera-tool-btn" title="Yakınlaştır">
