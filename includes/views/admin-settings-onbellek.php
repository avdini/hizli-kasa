                        ...
                        <form method="post" action="options.php">
                            ...
                            <table class="hk-cache-grid">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="hk-cache-title">ğŸ” ÃœrÃ¼n AramasÄ±</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="hk-cache-title">ğŸ¢ Depo Listesi</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="hk-cache-title">ğŸ” KullanÄ±cÄ± Yetkileri</div>
                                        </td>
                                        <td>
                            ...
                            <div style="margin-top: 20px; display: flex; align-items: center; justify-content: space-between;">
                                ...
                                <button type="button" class="button button-link-delete" style="color: #d63638;" onclick="if(confirm('TÃ¼m Ã¶nbellek silinecek emin misiniz?')) clearHKCache('all', this)">TÃ¼m Sistemi Temizle (Flush All)</button>
                            </div>
                        </form>
                    </div>
