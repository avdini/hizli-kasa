...
<div id="stok-terminali">
    ...
    <div class="terminal-header">
        ...
        <div class="arama-kutusu-wrapper">
            ...
            <!-- Detaylı Arama / Filtre Butonu -->
            <button id="btn-terminal-filtre-toggle" class="terminal-btn btn-filtre-toggle" title="Detaylı Filtreler">
    ...
    <!-- Aktif Filtre Rozetleri (Chips Bar) -->
    <div id="active-filter-chips" class="active-filter-chips-bar" style="display:none;">
        <span class="chips-label">Aktif Filtreler:</span>
